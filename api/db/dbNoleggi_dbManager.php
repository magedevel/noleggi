...
function getConnection() {
	...
	global $db_Noleggi_db_Url, $db_Noleggi_db_User, $db_Noleggi_db_Pass, $db_Noleggi_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Noleggi_db_Url.";dbname=".$db_Noleggi_db_DbName, $db_Noleggi_db_User, $db_Noleggi_db_Pass);
